...
<template>
    <header class="fixed mx-auto flex justify-center w-full z-[99] transition-all ease-in-out duration-300"
        ...
        <div class="max-w-[110em] py-2 lg:py-2 w-full px-5 lg:px-0 flex flex-row justify-between items-center relative">
            ...
            <nav class="text-sm lg:text-base tracking-wider w-[calc(100%-var(--spacing)*6)] lg:w-fit flex flex-col lg:flex-row gap-4 uppercase items-center lg:scale-100 lg:justify-start absolute lg:relative font-secondary lg:opacity-100 top-[4.9rem] lg:top-0 right-3 lg:right-0 py-2 pt-4 lg:pt-0 lg:py-0 px-2 lg:px-0 bg-back-900 dark:bg-back-800 lg:bg-back-200/0 dark:lg:bg-back-800/0 transition-all ease-in-out rounded-xl"
