...
<template>
    <section
        ...
        <div class="w-full -mt-5 lg:-mt-8 lg:pt-3 lg:text-center lg:px-24">
            ...
            <h4 class="mt-2 tracking-[0.23em] font-light text-lg lg:text-2xl text-back-900 dark:text-back-500 bg-white/40 lg:bg-transparent dark:bg-transparent rounded-lg">
                Creativity are no limits</h4>
        </div>
    </section>

    <section class="w-full px-3 lg:px-24 -mt-18 lg:-mt-24 pb-18 md:pb-20 lg:pb-24">
        <div
            class="w-full py-3 lg:py-2 bg-white dark:bg-back-900 px-4 lg:px-8 rounded-xl flex flex-row justify-between items-center max-w-[90vw] lg:max-w-[72vw] mx-auto shadow-2xl shadow-black">
            <h1 class="text-sm lg:text-lg lg:tracking-wider font-light">Its all about art</h1>
            <div class="w-fill flex flex-row gap-2 items-center justify-end">
                <input ref="search" placeholder="Search" type="search"
                    ...
                    :class="[searchToggle ? 'w-[100%] px-3 lg:px-4' : 'w-[0%]']" />
